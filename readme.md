...
When entering Admin Mode players will have their inventory, position, gamemode, XP, health
and hunger saved in order to retrieve them unchanged when exiting Admin Mode.
